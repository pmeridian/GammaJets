{  
  ...
  // mc distributions
  TFile* inFileMC=TFile::Open("tandp_ntuple_tagTight_HLT___mc.root");    
  TTree* inTreeMC=(TTree*)inFileMC->Get("myTaPDir/myTree");

  // data distributions
  TFile* inFileData=TFile::Open("tandp_ntuple_tagTight_HLT___data.root");  
  ...
  inTreeMC->Draw("probe_pt           >> h1_pt_EB_Mc(120,0.,180.)",             "puW*(abs(probe_eta)<1.5)");
  ...
  inTreeMC->Draw("probe_sEtaPhi      >> h1_sEtaPhi_EB_Mc(120,-0.0002,0.0002)", "puW*(abs(probe_eta)<1.5)");
  ...
  inTreeMC->Draw("probe_pt           >> h1_pt_EE_Mc(120,0.,180.)",             "puW*(abs(probe_eta)>1.5)");
  ...
  inTreeData->Draw("probe_pt           >> h1_pt_EB_Data(120,0.,180.)",             "1.*(abs(probe_eta)<1.5)");
  ...
  inTreeData->Draw("probe_sEtaPhi      >> h1_sEtaPhi_EB_Data(120,-0.0002,0.0002)", "1.*(abs(probe_eta)<1.5)");
  ...
  inTreeData->Draw("probe_pt           >> h1_pt_EE_Data(120,0.,180.)",             "1.*(abs(probe_eta)>1.5)");
