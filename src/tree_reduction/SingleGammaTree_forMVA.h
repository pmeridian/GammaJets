#ifndef SingleGammaTree_forMVA_h
#define SingleGammaTree_forMVA_h
...
class SingleGammaTree_forMVA : public tree_reader_V8 {

public:
  
  SingleGammaTree_forMVA(TTree *tree=0, const TString& outname="redntp.root");
  //virtual ~SingleGammaTree_forMVA(){};
  virtual ~SingleGammaTree_forMVA();
  virtual void     Loop();
