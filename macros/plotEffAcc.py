...
plotPars={}
plotPars['ptPhotGen']=dict( name='ptPhotGen', nBins=200, xMin=0., xMax=200., xaxisLabel="#gamma p_{T} (GeV)")
...
cuts['EB']='abs(etaPhotGen)<1.4442'
cuts['EE']='abs(etaPhotGen)>1.566 && abs(etaPhotGen)<2.5'
